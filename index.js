...
/*Task 1: counterMaker()
  ...
  counter 1 declares the variable count in the function which means it is function scoped, counter 2 declares the variable in the glabol which means it is global scoped!
  2. Which of the two uses a closure? How can you tell?
  counter1, becuase it has return function, because the variable is declared inside the function!
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
  counter1 is preferred for when i want private variables since there function scoped they cant be used but within the function, counter 2 is preffered when i want to use my variable for if i want to use it later on.
*/
...
console.log('task 3:', getInningScore(inning));
